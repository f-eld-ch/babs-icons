...
const SHEET_RE = /^(babs-(de|fr|it)|un-signs)(@[23]x)?\.(json|png)$/;

/**
 * Vite plugin that serves and emits the BABS language sheets and the un-signs
 * sheet at a fixed, unhashed path.
 *
